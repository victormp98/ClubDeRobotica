...
def auto_seed_torneo(app):
    with app.app_context():
        # Crear las tablas solo si no existen (Create_all no borra ni sobrescribe tablas existentes)
        db.create_all()
        ...
        db.session.commit()
        app.logger.info("[*] Auto-seed Torneo revisado e inyectado si era necesario.")
